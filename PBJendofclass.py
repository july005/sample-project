...
if Bread > 2 and peanut_butter > 1 and Jelly > 1:
    print "GOAL 1 I can make a sandwich" 
else:
    print "GOAL 1 You can NOT make a sandwich"
...
if Bread > 2 and peanut_butter > 1 and Jelly > 1 and Bread/2/peanut_butter != 1 and Bread/2/Jelly != 1:
    print "GOAL 2 I can't make a sandwich"
elif Bread < 2 and peanut_butter < 1 and Jelly < 1 and Bread/2/peanut_butter !=1 and Bread/2/Jelly != 1:
    print "GOAL 2 hell yeah"
else:
    print "GOAL 2 You can make a sandwich but I'm not sure if you'd had leftovers"
